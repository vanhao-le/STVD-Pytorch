...
NUM_THREADS = 60
VIDEO_ROOT = r'E:\STVD\stvd\setc\negative'   # Directory for videos
# VIDEO_ROOT = r'E:\STVD_DL\root_data'
FRAME_ROOT = r'E:\STVD_DL\data\train'  # Directory for extracted frames

groundtruth_file = r"data\neg_train_metadata.csv"
...
def extract(video, classIDx, tmpl='%04d.jpg'):
    ...
    # str_command = f'ffmpeg -nostats -loglevel 0 -i {VIDEO_ROOT}/{classIDx}/{video} -vf fps=1 ' f'{FRAME_ROOT}/{classIDx}/{tmpl}'
